...
def test_add_patient(get_repository):
    get_repository.add_patient({'fullName': 'test', 'teeth': '11,12', 'actions': 'test', 'price': '120', 'comment': 'test', 'language': 'eng', 'date': '2024-01-01'}, 1)
    get_repository.add_patient({'fullName': 'test2', 'teeth': '11,12', 'actions': 'test', 'price': '120', 'comment': 'test', 'language': 'eng', 'date': '2024-01-01'}, 1)
...
def test_update_patient(get_repository):
    get_repository.add_patient({'fullName': 'test', 'teeth': '11,12', 'actions': 'test', 'price': '120', 'comment': 'test', 'language': 'eng', 'date': '2024-01-01'}, 1)
    get_repository.update_patient({'fullName': 'test2', 'teeth': '11,122', 'actions': 'test2', 'price': '1202', 'comment': 'test2', 'language': 'eng', 'date': '2024-01-01'}, 1, 1)
...
def test_get_patient(get_repository):
    ...
    assert {'id': 1, 'fullname': 'test', 'teeth': '11,12', 
            ...
            'language': 'eng', 'date': '2024-01-01'} == get_repository.get_patient(1, 1)
...
def test_get_patient_lang_svg(get_repository):
    ...
    get_repository.add_patient({'fullName': 'test', 'teeth': '11,12', 'actions': 'test', 'price': '120', 
                                'comment': 'test', 'language': '', 'date': '2024-01-01'}, 1)
    assert {'id': 1, 'fullname': 'test', 'teeth': '11,12', 
            'actions': 'test', 'price': '120', 'comment': 'test', 'lang_svg': 'gbr',
            'language': 'Англійська', 'date': '2024-01-01'} == get_repository.get_patient(1, 1)
    assert {'id': 2, 'fullname': 'test', 'teeth': '11,12', 
            'actions': 'test', 'price': '120', 'comment': 'test', 'lang_svg': 'pol',
            'language': 'Польська', 'date': '2024-01-01'} == get_repository.get_patient(2, 1)
    assert {'id': 3, 'fullname': 'test', 'teeth': '11,12', 
            'actions': 'test', 'price': '120', 'comment': 'test', 'lang_svg': 'ukr',
            'language': 'Українська', 'date': '2024-01-01'} == get_repository.get_patient(3, 1)
    assert {'id': 4, 'fullname': 'test', 'teeth': '11,12', 
            'actions': 'test', 'price': '120', 'comment': 'test', 'lang_svg': 'unknown',
            'language': '', 'date': '2024-01-01'} == get_repository.get_patient(4, 1)
